	...
	<div class="panel panel-primary">
      ...
      <form class="form-horizontal" method="POST">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  <input id="nombre" name="nombre" placeholder="Nombre" value="<?php echo $datos['nombre']; ?>" class="form-control input-md" required="" type="text">
				  ...
				  <div class="col-md-4">
				    <select id="clave" name="clave" class="form-control js-example-basic-single" required style="width: 100%">
				    	...
				    	<?php foreach ($materias as $valor) { ?>
				    		<option <?php echo ($datos['Materia_clave'] == $valor['clave'])?"Selected":""; ?> value="<?php echo $valor['clave']; ?>"><?php echo $valor['nombre_carrera'] . " - " . $valor['nombre']; ?></option>
				    	<?php } ?>
				    	<?php unset($valor); ?>
				    </select>
				  </div>
				  ...
				  <div class="col-md-4">
				    <select id="idPeriodo" name="idPeriodo" class="form-control js-example-basic-single" required style="width: 100%">
				    	...
				    	<?php foreach ($periodos as $valor) { ?>
				    		<option <?php echo ($datos['Periodo_idPeriodo'] == $valor['idPeriodo'])?"Selected":""; ?> value="<?php echo $valor['idPeriodo']; ?>"><?php echo $valor['nombre']; ?></option>
				    	<?php } ?>
				    	<?php unset($valor); ?>
				    </select>
				  </div>
				  ...
				  <div class="col-md-4">
				    <select id="idCiclo" name="idCiclo" class="form-control js-example-basic-single" required style="width: 100%">
				    	...
				    	<?php foreach ($ciclos as $valor) { ?>
				    		<option <?php echo ($datos['Ciclo_idCiclo'] == $valor['idCiclo'])?"Selected":""; ?> value="<?php echo $valor['idCiclo']; ?>"><?php echo $valor['nombre']; ?></option>
				    	<?php } ?>
				    	<?php unset($valor); ?>
				    </select>
				  </div>
				  ...
				  <div class="col-md-4">
				    <select id="idAsesor" name="idAsesor" class="form-control js-example-basic-single" required style="width: 100%">
				    	...
				    	<?php foreach ($asesores as $valor) { ?>
				    		<option <?php echo ($datos['Asesor_idAsesor'] == $valor['idAsesor'])?"Selected":""; ?> value="<?php echo $valor['idAsesor']; ?>"><?php echo $valor['nombre']; ?></option>
				    	<?php } ?>
				    	<?php unset($valor); ?>
				    </select>
				  </div>
