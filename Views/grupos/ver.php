        ...
        <div class="caption">
          ...
          <div align="right">
            <div class="btn-group" role="group" aria-label="...">
              ...
              <button href="<?php echo URL; ?>evaluaciones/enviar/<?php echo $datos['idGrupo']; ?>?s=1" class="btn btn-default redirect" title="Enviar" <?php echo $s1['disabled']; ?>><i class="fa fa-paper-plane fa-lg fa-fw text-primary" aria-hidden="true"></i></button>
        ...
        <div class="caption">
          ...
          <div align="right">
            <div class="btn-group" role="group" aria-label="...">
              ...
              <button href="<?php echo URL; ?>evaluaciones/enviar/<?php echo $datos['idGrupo']; ?>?s=2" class="btn btn-default redirect" title="Enviar" <?php echo $s2['disabled']; ?>><i class="fa fa-paper-plane fa-lg fa-fw text-primary" aria-hidden="true"></i></button>
        ...
        <div class="caption">
          ...
          <div align="right">
            <div class="btn-group" role="group" aria-label="...">
              ...
              <button href="<?php echo URL; ?>evaluaciones/enviar/<?php echo $datos['idGrupo']; ?>?s=3" class="btn btn-default redirect" title="Enviar" <?php echo $s3['disabled']; ?>><i class="fa fa-paper-plane fa-lg fa-fw text-primary" aria-hidden="true"></i></button>
        ...
        <div class="caption">
          ...
          <div align="right">
            <div class="btn-group" role="group" aria-label="...">
              ...
              <button href="<?php echo URL; ?>evaluaciones/enviar/<?php echo $datos['idGrupo']; ?>?s=4" class="btn btn-default redirect" title="Enviar" <?php echo $s4['disabled']; ?>><i class="fa fa-paper-plane fa-lg fa-fw text-primary" aria-hidden="true"></i></button>
        ...
        <div class="caption">
          ...
          <div align="right">
            <div class="btn-group" role="group" aria-label="...">
              ...
              <button href="<?php echo URL; ?>evaluaciones/enviar/<?php echo $datos['idGrupo']; ?>?s=5" class="btn btn-default redirect" title="Enviar" <?php echo $s5['disabled']; ?>><i class="fa fa-paper-plane fa-lg fa-fw text-primary" aria-hidden="true"></i></button>
        ...
        <div class="caption">
          ...
          <div align="right">
            <div class="btn-group" role="group" aria-label="...">
              ...
              <button href="<?php echo URL; ?>evaluaciones/enviar/<?php echo $datos['idGrupo']; ?>?s=6" class="btn btn-default redirect" title="Enviar" <?php echo $s6['disabled']; ?>><i class="fa fa-paper-plane fa-lg fa-fw text-primary" aria-hidden="true"></i></button>
